...
goog.exportSymbol('proto.order.Image', null, global);
 ...
 * @constructor
 */
proto.order.Image = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.order.Image, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.order.Image.displayName = 'proto.order.Image';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.order.SetItemStatusClaimRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.order.Image.toObject, includeInstance)
  };
...
proto.order.SetItemStatusClaimRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.order.Image;
      reader.readMessage(value,proto.order.Image.deserializeBinaryFromReader);
      msg.addImages(value);
      break;
    default:
      reader.skipField();
...
proto.order.SetItemStatusClaimRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.order.Image.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.order.Image>}
 */
proto.order.SetItemStatusClaimRequest.prototype.getImagesList = function() {
  return /** @type{!Array<!proto.order.Image>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.order.Image, 3));
};


/**
 * @param {!Array<!proto.order.Image>} value
 * @return {!proto.order.SetItemStatusClaimRequest} returns this
*/
...
/**
 * @param {!proto.order.Image=} opt_value
 * @param {number=} opt_index
 * @return {!proto.order.Image}
 */
proto.order.SetItemStatusClaimRequest.prototype.addImages = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.order.Image, opt_index);
};
 ...
 * @return {!Object}
 */
proto.order.Image.prototype.toObject = function(opt_includeInstance) {
  return proto.order.Image.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.order.Image} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.order.Image.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.order.Image}
 */
proto.order.Image.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.order.Image;
  return proto.order.Image.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.order.Image} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.order.Image}
 */
proto.order.Image.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.order.Image.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.order.Image.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.order.Image} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.order.Image.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.order.Image.prototype.getContent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.order.Image.prototype.getContent_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.order.Image.prototype.getContent_asU8 = function() {
 ...
 * @return {!proto.order.Image} returns this
 */
proto.order.Image.prototype.setContent = function(value) {
